...
#switch the Ntupes files with the name of the list of ntuples files available on the virtual machine
...
#insert sym links for your input Ntuples datafiles in the labo2 directory for electrons and muons
ln -s ../data/NtuplesfilesMuons labo2/
ln -s ../data/NtuplesfilesElectrons labo2/
ln -s ../Delphes-3.3.2/delpheAnalysisW.root labo3/
#create sym links for your input Ntuples datafiles in the labo3 directory for electrons and muons
